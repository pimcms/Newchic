	...
	function bufferLoad(){
		var appendDiv = '<div class="buffer_loading"><div class="animate-loader"><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div></div></div>';
